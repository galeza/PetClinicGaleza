...
public class PetClinicTest extends BaseTest {
	...
	public static Object[][] findSpecificOwner() {
		...
		return new Object[][] { { "Peter", "McTavish", "2387 S. Fair Way", "Madison", "6085552765" }, };
	...
	public static Object[][] ownerAddPet() {
		...
		return new Object[][] { { "Peter", "McTavish", RandomValues.getRandomAlphaNumericWithSize(5), getLocatDate(),
	...
	public void addPetTest(String firstName, String lastName, String petName, String petBirthDate, String petType) {
		...
		Collection<List<String>> petsDetails = ownerInfoPage.openNewPetPage().addNewPet(petName, dateParts[2].replaceFirst("^0*", ""), petType)
				.readPetDetails();
	...
	public static Object[][] petNameValidation() {
		...
		return new Object[][] {
				{ "Jeff", "Black", "Lucky", getLocatDate(), PetType.getRandomPetType().toString().toLowerCase() }, };
